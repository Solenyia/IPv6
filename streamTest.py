...
class streamTest(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "streamTest")
...
def main(top_block_cls=streamTest, options=None):
