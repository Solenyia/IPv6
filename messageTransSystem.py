...
class messageTransSystem(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "messageTransSystem")
...
def main(top_block_cls=messageTransSystem, options=None):
